...
warp_script(){
	...
	case $warpNumberInput in
        ...
        2) wget -N https://raw.githubusercontent.com/fscarmen/warp/main/docker.sh && bash docker.sh ;;
        3) bash <(curl -sSL https://raw.githubusercontent.com/fscarmen/warp_unlock/main/unlock.sh) ;;
        4) bash <(curl -fsSL https://raw.githubusercontent.com/P3TERX/warp.sh/main/warp.sh) menu ;;
        0) menu ;;
    esac
}
...
xui() {
    ...
    case "$xuiNumberInput" in
        ...
        2) wget -N --no-check-certificate https://raw.githubusercontent.com/Dicksoi/x-ui/master/install.sh && bash install.sh ;;
...
menu1(){
    ...
    case $menuInput in
        1) open_ports ;;
        2) wget -N --no-check-certificate https://raw.githubusercontent.com/Dicksoi/rootLogin/master/root.sh && bash root.sh ;;
        3) wget -N --no-check-certificate https://raw.githubusercontent.com/Dicksoi/screenManager/master/screen.sh && bash screen.sh ;;
        4) bbr_script ;;
        5) v6_dns64 ;;
        6) warp_script ;;
        7) curl -fsSL https://get.docker.com | bash -s docker --mirror Aliyun ;;
        8) wget -N --no-check-certificate https://raw.githubusercontent.com/Dicksoi/acme-1key/master/acme1key.sh && bash acme1key.sh ;;
        9) wget -N --no-check-certificate https://raw.githubusercontent.com/Dicksoi/argo-tunnel-script/master/argo.sh && bash argo.sh ;;
        10) wget -N --no-check-certificate https://raw.githubusercontent.com/Dicksoi/Ngrok-1key/master/ngrok.sh && bash ngrok.sh ;;
        11) bash <(curl -sSL https://cdn.jsdelivr.net/gh/SuperManito/LinuxMirrors@main/ChangeMirrors.sh) ;;
        12) setChinese ;;
        13) wget -N --no-check-certificate https://raw.githubusercontent.com/Dicksoi/tun-script/master/tun.sh && bash tun.sh ;;
        *) exit 1 ;;
    esac
}
